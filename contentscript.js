...
function PopBadUid(){
  ...
  var ovFilterButton = document.getElementById("filter_" + this.parentNode.parentNode.parentNode.parentNode.id);
...
function AddFilterButton(opElem, bpFlag){
  var ovFilterButton = document.getElementById("filter_" + opElem.parentNode.parentNode.parentNode.parentNode.id);
